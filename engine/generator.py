...
def generate_copper_deposits(vp, x, y, s):
    ...
    if prob > random.random():
        vp.item_layer[y][x] = CopperOreDeposit(x, y, vp, random.randint(150, 500))
...
def generate_coal_deposits(vp, x, y, s):
    ...
    if prob > random.random():
        vp.item_layer[y][x] = CoalDeposit(x, y, vp, random.randint(150, 500))
...
def generate_stone_deposits(vp, x, y, s):
    ...
    if prob > random.random():
        vp.item_layer[y][x] = StoneDeposit(x, y, vp, quantity=50)
